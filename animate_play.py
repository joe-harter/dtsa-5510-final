...
# Taken in full from https://www.kaggle.com/code/huntingdata11/animated-and-interactive-nfl-plays-in-plotly/notebook
...
def animate_play(tracking_df, play_df, players, gameId, playId):
    selected_play_df = play_df[
        (play_df.playId == playId) & (play_df.gameId == gameId)
    ].copy()
    tracking_players_df = pd.merge(tracking_df, players, how="left", on="nflId")
    selected_tracking_df = tracking_players_df[
        (tracking_players_df.playId == playId) & (tracking_players_df.gameId == gameId)
    ].copy()
            ...
            if team != "football":
                ...
                for nflId in plot_df.nflId:
                    ...
                    hover_text_array.append(
                        "nflId:{}<br>displayName:{}<br>position:{}".format(
    ...
    layout = go.Layout(
        ...
        yaxis=dict(
            range=[0, 53.3], autorange=False, showgrid=False, showticklabels=False
        ),
        plot_bgcolor="#00B140",
